...
//             const session_url1 = credentials.uri + '/destination-configuration/v1/destinations/destservicemsgraph';
//             var config1 = {
//                 method: 'get',
//                 url: session_url1,
//                 headers: {
...
//             axios(config1)
//             .then(function (response) {
//                 const session_url2 = response.data.destinationConfiguration.URL + `/v1.0/users/${data.sender}/sendmail`;
//                 var config2 = {
//                     method: 'get',
//                     url: session_url2,
//                     headers: {
...
// //     const baseUrl = '<BTP_ENDPOINT>'; 
//     // Replace with your BTP endpoint URL // Set up the Axios instance const instance = axios.create({ baseURL: baseUrl, headers: { 'Authorization': 'Bearer <ACCESS_TOKEN>', // Replace with your access token 'Content-Type': 'application/json' } }); try { // Make the API call const response = await instance.get('/destination-configuration/v1/destinations'); // Handle the response console.log('Destinations:', response.data.destinations); } catch (error) { console.error('Error retrieving destinations:', error); } } // Call the function getDestinations();
